...
:TEST_cdate_1971_jan_01_equals_365_days
    call "%~dp0cdate.bat" 1971 1 1 0 0 0
    set /a secs=24*60*60*365
    if %cdate% neq %secs% exit /b 1
exit /b 0

:TEST_cdate_1971_dec_01_equals_1y_and_334_days
    call "%~dp0cdate.bat" 1971 12 1 0 0 0
    set /a secs=24*60*60*(365+334)
    if %cdate% neq %secs% exit /b 1
exit /b 0

:TEST_cdate_1971_dec_31_equals_1y_and_364_days
...
:TEST_cdate_1972_jan_01_equals_730_days
...
rem 29 Feb 1972
:TEST_cdate_1972_mar_01_check_29_days_in_feb_in_leap_year_1972
    call "%~dp0cdate.bat" 1972 3 1 0 0 0
    set /a secs=24*60*60*(730+31+29)
    if %cdate% neq %secs% exit /b 1
exit /b 0

:TEST_cdate_1973_jan_01_check_366_days_in_leap_year_1972
...
:TEST_cdate_negative_hour_cross_month
...
:TEST_cdate_negative_hour_cross_day
...
:TEST_cdate_negative_hour_cross_year
...
:TEST_cdate_negative_minute_cross_month
    call "%~dp0cdate.bat" 2024 2 29 21 0 0
    set cdate_expected=%cdate%
...
:TEST_cdate_negative_minute_cross_day
    call "%~dp0cdate.bat" 2024 2 28 22 0 0
    set cdate_expected=%cdate%
...
:TEST_cdate_negative_minute_cross_year
    call "%~dp0cdate.bat" 2023 12 31 19 0 0
    set cdate_expected=%cdate%
...
:TEST_cdate_negative_second_cross_year
